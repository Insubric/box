...
object BoxNews {
  ...
  class BoxNews(_tableTag: Tag) extends Table[BoxNews_row](_tableTag,Some(BoxSchema.schema),"news") {
  ...
  class BoxNews_i18n(_tableTag: Tag) extends Table[BoxNews_i18n_row](_tableTag,Some(BoxSchema.schema), "news_i18n") {
