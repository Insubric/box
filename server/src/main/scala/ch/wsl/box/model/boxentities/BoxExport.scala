...
object BoxExport {
  ...
  class BoxExport(_tableTag: Tag) extends Table[BoxExport_row](_tableTag,schema, "export") {
  ...
  class BoxExport_i18n(_tableTag: Tag) extends Table[BoxExport_i18n_row](_tableTag,schema, "export_i18n") {
