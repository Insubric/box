...
object BoxFunction {
  ...
  class BoxFunction(_tableTag: Tag) extends Table[BoxFunction_row](_tableTag,Some(BoxSchema.schema), "function") {
  ...
  class BoxFunction_i18n(_tableTag: Tag) extends Table[BoxFunction_i18n_row](_tableTag,Some(BoxSchema.schema), "function_i18n") {
  ...
  class BoxFunctionField(_tableTag: Tag) extends Table[BoxFunctionField_row](_tableTag,Some(BoxSchema.schema), "function_field") {
  ...
  class BoxFunctionField_i18n(_tableTag: Tag) extends Table[BoxFunctionField_i18n_row](_tableTag,Some(BoxSchema.schema), "function_field_i18n") {
