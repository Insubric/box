...
object BuildBox {
  ...
  def install(username:String) = {
    
    val createSchemaStatement = s"create schema if not exists ${BoxSchema.schema};"
...
CREATE TABLE "#${BoxSchema.schema}".access_level (
    access_level_id serial NOT NULL,
    access_level text NOT NULL
);


CREATE TABLE #${BoxSchema.schema}.conf (
    id serial NOT NULL,
...
CREATE TABLE #${BoxSchema.schema}.export (
...
CREATE TABLE #${BoxSchema.schema}.export_field (
...
CREATE TABLE #${BoxSchema.schema}.export_field_i18n (
    id serial NOT NULL,
    field_id integer,
...
CREATE TABLE #${BoxSchema.schema}.export_header_i18n (
    id serial NOT NULL,
    key character varying NOT NULL,
...
CREATE TABLE #${BoxSchema.schema}.export_i18n (
    id serial NOT NULL,
    export_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${BoxSchema.schema}.field (
    field_id serial NOT NULL,
...
CREATE TABLE #${BoxSchema.schema}.field_file (
...
CREATE TABLE #${BoxSchema.schema}.field_i18n (
    id serial NOT NULL,
    field_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${BoxSchema.schema}.form (
...
CREATE TABLE #${BoxSchema.schema}.form_i18n (
    id serial NOT NULL,
    form_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${BoxSchema.schema}.function (
...
CREATE TABLE #${BoxSchema.schema}.function_field (
    field_id serial NOT NULL,
...
CREATE TABLE #${BoxSchema.schema}.function_field_i18n (
    id serial NOT NULL,
    field_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${BoxSchema.schema}.function_i18n (
    id serial NOT NULL,
    function_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${BoxSchema.schema}.labels (
    id serial NOT NULL,
    lang character varying NOT NULL,
    key character varying NOT NULL,
    label character varying
...
CREATE TABLE #${BoxSchema.schema}.ui (
    id serial NOT NULL,
    key character varying NOT NULL,
...
CREATE TABLE #${BoxSchema.schema}.ui_src (
    id serial NOT NULL,
    file bytea,
...
CREATE TABLE #${BoxSchema.schema}.users (
    username character varying NOT NULL,
    access_level_id integer NOT NULL
);

ALTER TABLE ONLY #${BoxSchema.schema}.access_level
    ADD CONSTRAINT access_level_pkey PRIMARY KEY (access_level_id);


ALTER TABLE ONLY #${BoxSchema.schema}.conf
    ADD CONSTRAINT conf_pkey PRIMARY KEY (id);

ALTER TABLE ONLY #${BoxSchema.schema}.export_field_i18n
    ADD CONSTRAINT export_field_i18n_pkey PRIMARY KEY (id);


ALTER TABLE ONLY #${BoxSchema.schema}.export_field
    ADD CONSTRAINT export_field_pkey PRIMARY KEY (field_id);


ALTER TABLE ONLY #${BoxSchema.schema}.export_header_i18n
    ADD CONSTRAINT export_header_i18n_pkey PRIMARY KEY (id);


ALTER TABLE ONLY #${BoxSchema.schema}.export_i18n
    ADD CONSTRAINT export_i18n_pkey PRIMARY KEY (id);


ALTER TABLE ONLY #${BoxSchema.schema}.export
    ADD CONSTRAINT export_pkey PRIMARY KEY (export_id);



ALTER TABLE ONLY #${BoxSchema.schema}.field_file
    ADD CONSTRAINT field_file_pkey PRIMARY KEY (field_id);



ALTER TABLE ONLY #${BoxSchema.schema}.field_i18n
    ADD CONSTRAINT field_i18n_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${BoxSchema.schema}.field
    ADD CONSTRAINT field_pkey PRIMARY KEY (field_id);




ALTER TABLE ONLY #${BoxSchema.schema}.form_i18n
    ADD CONSTRAINT form_i18n_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${BoxSchema.schema}.form
    ADD CONSTRAINT form_pkey PRIMARY KEY (form_id);



ALTER TABLE ONLY #${BoxSchema.schema}.function_field_i18n
    ADD CONSTRAINT function_field_i18n_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${BoxSchema.schema}.function_field
    ADD CONSTRAINT function_field_pkey PRIMARY KEY (field_id);


ALTER TABLE ONLY #${BoxSchema.schema}.function_i18n
    ADD CONSTRAINT function_i18n_pkey PRIMARY KEY (id);


ALTER TABLE ONLY #${BoxSchema.schema}.function
...
ALTER TABLE ONLY #${BoxSchema.schema}.labels
...
ALTER TABLE ONLY #${BoxSchema.schema}.ui
    ADD CONSTRAINT ui_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${BoxSchema.schema}.ui_src
    ADD CONSTRAINT ui_src_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${BoxSchema.schema}.users
    ADD CONSTRAINT users_pkey PRIMARY KEY (username);



ALTER TABLE ONLY #${BoxSchema.schema}.field_file
    ADD CONSTRAINT field_file_fielf_id_fk FOREIGN KEY (field_id) REFERENCES #${BoxSchema.schema}.field(field_id);


ALTER TABLE ONLY #${BoxSchema.schema}.export_i18n
    ADD CONSTRAINT fkey_export FOREIGN KEY (export_id) REFERENCES #${BoxSchema.schema}.export(export_id);
...
ALTER TABLE ONLY #${BoxSchema.schema}.export_field_i18n
    ADD CONSTRAINT fkey_field FOREIGN KEY (field_id) REFERENCES #${BoxSchema.schema}.export_field(field_id);


ALTER TABLE ONLY #${BoxSchema.schema}.field_i18n
    ADD CONSTRAINT fkey_field FOREIGN KEY (field_id) REFERENCES #${BoxSchema.schema}.field(field_id) ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY #${BoxSchema.schema}.function_field_i18n
    ADD CONSTRAINT fkey_field FOREIGN KEY (field_id) REFERENCES #${BoxSchema.schema}.function_field(field_id) ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY #${BoxSchema.schema}.field
    ADD CONSTRAINT fkey_form FOREIGN KEY (form_id) REFERENCES #${BoxSchema.schema}.form(form_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY #${BoxSchema.schema}.function_i18n
    ADD CONSTRAINT fkey_function FOREIGN KEY (function_id) REFERENCES #${BoxSchema.schema}.function(function_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY #${BoxSchema.schema}.function_field
    ADD CONSTRAINT fkey_function FOREIGN KEY (function_id) REFERENCES #${BoxSchema.schema}.function(function_id) ON UPDATE CASCADE ON DELETE CASCADE;
              ...
              """
      _ <- BoxAccessLevel.BoxAccessLevelTable ++= Seq(
      ...
      _ <- BoxConf.BoxConfTable ++= Seq(
        BoxConf.BoxConf_row(key = "host", value = Some("0.0.0.0")),
        BoxConf.BoxConf_row(key = "port", value = Some("8080")),
        BoxConf.BoxConf_row(key = "server-secret", value = Some(scala.util.Random.alphanumeric.take(256).mkString)),
      ...
      _ <- BoxUIsrcTable.BoxUIsrcTable += BoxUIsrcTable.BoxUIsrc_row(file = Some(Base64.getDecoder.decode(logo)),mime = Some("image/png"),name = Some("logo"),accessLevel = -1)
      _ <- BoxUITable.BoxUITable ++= Seq(
      ...
      _ <- sqlu"""CREATE OR REPLACE VIEW #${BoxSchema.schema}."v_roles" AS
                          SELECT r.rolname,
                                r.rolsuper,
                                r.rolinherit,
                                r.rolcreaterole,
      ...
      _ <- sqlu"""CREATE OR REPLACE FUNCTION #${BoxSchema.schema}.hasrole(rol text)
                                       RETURNS boolean
                                       LANGUAGE plpgsql
                                       AS $$function$$
                                       DECLARE
                                            roles text[];
                                       BEGIN
                                             select memberof into roles from #${BoxSchema.schema}.v_roles where lower(rolname) = lower(current_user);
                                             return rol = any(roles);
                                      END
                                      $$function$$
      """

      _ <- sqlu"""CREATE OR REPLACE FUNCTION #${BoxSchema.schema}.hasrolein(rol text[])
                                       RETURNS boolean
                                       LANGUAGE plpgsql
                                        AS $$function$$
                                        DECLARE
  ...
  def main(args: Array[String]): Unit = {
    ...
    DefaultModule.connectionOnly.build[Connection] { connection =>
      val installShowError = connection.dbConnection.run(install(connection.adminUser).transactionally).recover{ case t:Throwable => t.printStackTrace()}

      Await.result(installShowError, 30 seconds)

      Await.result(MigrateDB.box(connection,BoxSchema.schema), 120 seconds )
