...
object BuildBox {
  ...
  private def setUpBoxSchema(username: String, boxSchema: String) = {

    val createSchemaStatement = s"create schema if not exists ${boxSchema};"
...
CREATE TABLE "#${boxSchema}".access_level (
    access_level_id serial NOT NULL,
    access_level text NOT NULL
);


CREATE TABLE #${boxSchema}.conf (
    id serial NOT NULL,
...
CREATE TABLE #${boxSchema}.export_field (
...
CREATE TABLE #${boxSchema}.export_field_i18n (
    id serial NOT NULL,
    field_id integer,
...
CREATE TABLE #${boxSchema}.export_header_i18n (
    id serial NOT NULL,
    key character varying NOT NULL,
...
CREATE TABLE #${boxSchema}.export_i18n (
    id serial NOT NULL,
    export_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${boxSchema}.field_file (
...
CREATE TABLE #${boxSchema}.field_i18n (
    id serial NOT NULL,
    field_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${boxSchema}.form_i18n (
    id serial NOT NULL,
    form_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${boxSchema}.function (
...
CREATE TABLE #${boxSchema}.function_field (
    field_id serial NOT NULL,
...
CREATE TABLE #${boxSchema}.function_field_i18n (
    id serial NOT NULL,
    field_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
CREATE TABLE #${boxSchema}.function_i18n (
    id serial NOT NULL,
    function_id integer,
    lang character(2) DEFAULT NULL::bpchar,
    label character varying,
...
ALTER TABLE ONLY #${boxSchema}.labels
...
ALTER TABLE ONLY #${boxSchema}.ui
    ADD CONSTRAINT ui_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${boxSchema}.ui_src
    ADD CONSTRAINT ui_src_pkey PRIMARY KEY (id);



ALTER TABLE ONLY #${boxSchema}.users
    ADD CONSTRAINT users_pkey PRIMARY KEY (username);



ALTER TABLE ONLY #${boxSchema}.field_file
    ADD CONSTRAINT field_file_fielf_id_fk FOREIGN KEY (field_id) REFERENCES #${boxSchema}.field(field_id);


ALTER TABLE ONLY #${boxSchema}.export_i18n
    ADD CONSTRAINT fkey_export FOREIGN KEY (export_id) REFERENCES #${boxSchema}.export(export_id);
...
ALTER TABLE ONLY #${boxSchema}.export_field_i18n
    ADD CONSTRAINT fkey_field FOREIGN KEY (field_id) REFERENCES #${boxSchema}.export_field(field_id);


ALTER TABLE ONLY #${boxSchema}.field_i18n
    ADD CONSTRAINT fkey_field FOREIGN KEY (field_id) REFERENCES #${boxSchema}.field(field_id) ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY #${boxSchema}.function_field_i18n
    ADD CONSTRAINT fkey_field FOREIGN KEY (field_id) REFERENCES #${boxSchema}.function_field(field_id) ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY #${boxSchema}.field
    ADD CONSTRAINT fkey_form FOREIGN KEY (form_id) REFERENCES #${boxSchema}.form(form_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY #${boxSchema}.function_i18n
    ADD CONSTRAINT fkey_function FOREIGN KEY (function_id) REFERENCES #${boxSchema}.function(function_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY #${boxSchema}.function_field
    ADD CONSTRAINT fkey_function FOREIGN KEY (function_id) REFERENCES #${boxSchema}.function(function_id) ON UPDATE CASCADE ON DELETE CASCADE;
      ...
      _ <-
        sqlu"""CREATE OR REPLACE FUNCTION #${boxSchema}.hasrole(rol text)
                                       RETURNS boolean
                                       LANGUAGE plpgsql
                                       AS $$function$$
                                       DECLARE
                                            roles text[];
                                       BEGIN
                                             select memberof into roles from #${boxSchema}.v_roles where lower(rolname) = lower(current_user);
      ...
      _ <-
        sqlu"""CREATE OR REPLACE FUNCTION #${boxSchema}.hasrolein(rol text[])
                                       RETURNS boolean
                                       LANGUAGE plpgsql
                                        AS $$function$$
                                        DECLARE
