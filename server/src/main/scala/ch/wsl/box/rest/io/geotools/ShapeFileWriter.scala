...
//
//    //https://epsg.io/21781.esriwkt
//    val esriCRS = basicRequest.get(uri"https://epsg.io/${crs.srid}.esriwkt").response(asString).send(backend).body match {
//      case Left(value) => {
//        logger.warn(value)
//        org.geotools.referencing.CRS.decode(crs.name)
//      }
//      case Right(value) => org.geotools.referencing.CRS.parseWKT(value)
//    }
//
//
//    builder.setCRS(esriCRS)
//
//
...
//  }
//
//  private def createShapefile(schema: SimpleFeatureType,geomName:String,rows:Seq[ShapeFileRow]):Seq[ShapeFileElement] = {
//
...
//        case collection if collection.getGeometryType == "GeometryCollection" => {
//          throw new Exception("Geometry collection are not supported in shapefiles")
//        }
//        case f => {
...
//        }
//
//        val shapeFile = createShapefile(schema,geomCol,data)
//
