...
import ch.wsl.box.client.views.components.widget.child.{EditableTable, ExportWidget, LookupFormWidget, SimpleChildFactory, Spreadsheet, TableChildFactory, TrasparentChild}
...
import ch.wsl.box.client.views.components.widget.range.IntRangeWidget
